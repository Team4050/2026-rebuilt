...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGains = new Slot0Configs()
      ...
      .withKD(0.5)
      .withKS(0.1)
      .withKV(2.66) // Unnecessary with TorqueCurrentFOC
      .withKA(0)
  ...
  private static final Slot0Configs driveGains = new Slot0Configs()
      ...
      .withKD(0)
      .withKS(0)
      .withKV(0.124); // Unnecessary with TorqueCurrentFOC
  ...
  // =========================================================================================================================
  // Constructor methods - Do not edit
  // =========================================================================================================================
  ...
  public static class TunerSwerveDrivetrain extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder> {
     ...
     *          The standard deviation for odometry calculation in the form [x, y, theta]áµ€, with units in meters and
     *          radians
     * @param visionStandardDeviation
     *          The standard deviation for vision calculation in the form [x, y, theta]áµ€, with units in meters and
     *          radians
     * @param modules
     *          Constants for each specific module
     */
