...
public final class Elastic {
  ...
  private static final StringTopic selectedTabTopic = NetworkTableInstance
      .getDefault()
  ...
  /**
   * Selects the tab of the dashboard at the given index. If this index is greater than or equal to the number of tabs,
  ...
  /**
   * Represents an notification object to be sent to the Elastic dashboard. This object holds properties such as level,
   * title, description, display time, and dimensions to control how the notification is displayed on the dashboard.
   */
  public static class Notification {
    ...
    /**
     * Creates a new Notification with specified dimensions and default display time. If the height is below zero, it is
     * automatically inferred based on screen size.
     *
     * @param level
     *          the level of the notification
     * @param title
